...
async function getWeatherTool(fullPrompt: string, city: string = "London", enableEncryption: boolean = true) {
  try {
...
function formatBasicWeatherReport(weatherData: any, query: string, city: string, encryptionInfo: string): string {
  try {
